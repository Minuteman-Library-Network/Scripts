...
def sftp_file(local_file, file_name, library):
    ...
    remote_path = "/reports/Library-Specific Reports/{}/Old Lost and Paid".format(library)
...
def main(library,libcode):
    try:
        ...
        # Name of Excel File
        file_name = "{}OldLostandPaid{}.xlsx".format(libcode),date.today().replace(day=1).strftime("%b%Y"))
        excel_file =  "/Scripts/Old Lost and Paid/Temp Files/{}".format(file_name)
