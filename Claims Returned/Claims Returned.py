...
def sftp_file(local_file, file_name, library):
    ...
    remote_path = "/reports/Library-Specific Reports/{}/Claims Returned".format(library)
...
def main(library, libcode):
    try:
        ...
        # Name of Excel File
        file_name = "{}ClaimsReturned{}.xlsx".format(libcode,this_month.strftime("%b%Y"))
        excel_file = "/Scripts/Claims Returned/Temp Files/{}".format(file_name)
