...
Generates report of item counts by location and item status
"""
# run in py38
...
def main():
    ...
    excel_file = "/Scripts/Annual Reports/Archive/holdings by status{}.xlsx".format(
        date.today()
    )
    excel_writer(query_results, excel_file)

    # send email with attached file
    email_subject = "Holdings by Status"
    email_message = """***This is an automated email***


The Holdings By Status report has been attached."""
