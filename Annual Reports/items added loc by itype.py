...
def excel_writer(query_results, excel_file):
    ...
    eformatlabel= workbook.add_format({'text_wrap': True, 'valign': 'top', 'bold': True, 'rotation': -90})
...
def main():
    ...
    excel_file = "/Scripts/Annual Reports/Archive/items added loc by itype{}.xlsx".format(
        date.today()
    )
