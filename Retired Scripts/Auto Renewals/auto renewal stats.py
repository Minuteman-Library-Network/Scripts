...
#Name of Excel File
#csvFile =  'C:\\SQL Reports\\auto renewal stats\\auto_renewal_stats{}.csv'.format(date.today())
csvFile =  'auto_renewal_stats{}.csv'.format(date.today())
...
emailpass = ''
emailport = ''
emailsubject = 'auto renewal stats'
emailmessage = '''***This is an automated email***


The cam equipment circ report has been attached.'''
...
cursor = conn.cursor()
cursor.execute(open("auto renewal stats.sql","r").read())
