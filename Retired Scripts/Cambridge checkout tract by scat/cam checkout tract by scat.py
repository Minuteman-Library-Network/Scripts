...
#Name of Excel File
csvFile =  'ca_checkouts_by_scat{}.csv'.format(date.today())
...
emailpass = ''
emailport = ''
emailsubject = 'cam monthly checkouts by tract and scat'
emailmessage = '''***This is an automated email***


The cam monthly checkouts by tract and scat has been attached.'''
...
cursor = conn.cursor()
cursor.execute(open("cam checkout tract by scat.sql","r").read())
