...
def main():
    ...
    JOIN sierra_view.bib_record_item_record_link li
      ON h.record_id = li.item_record_id
    JOIN sierra_view.record_metadata rm
    ...
    /*
	 Union to second query to account for bib level holds where there are no items or volumes present
	 */  
    UNION
    ...
    /*
    Union to third query to account for volume level holds in addition to bib and item level ones
...
if __name__ == "__main__":
    try:
        ...
        email_subject = "LibraryIQ script error"
        email_message = (
