...
def sftp_file(local_file, file_name, library):
    ...
    remote_path = "/reports/Library-Specific Reports/{}/In Transit".format(library)
...
def main(library,libcode):
    ...
    try:
        ...
        # Name of Excel File
        file_name = "{}InTransit{}.xlsx".format(libcode,date.today().strftime("%b%Y"))
        excel_file =  "/Scripts/InTransit/Temp Files/{}".format(file_name)
