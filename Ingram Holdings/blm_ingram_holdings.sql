...
DROP TABLE IF EXISTS blm_bibs;

CREATE TEMP TABLE blm_bibs AS
...
ON
l.item_record_id = i.id  AND i.location_code ~ '^blm' AND i.item_status_code NOT IN ('w','$','z')
LEFT JOIN
...
ON
ol.order_record_id = o.id AND o.accounting_unit_code_num = '5' AND o.order_status_code IN ('o','q')
LEFT JOIN
