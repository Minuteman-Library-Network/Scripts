...
DROP TABLE IF EXISTS fpl_bibs;

CREATE TEMP TABLE fpl_bibs AS
...
ON
l.item_record_id = i.id  AND i.location_code ~ '^fp' AND i.item_status_code NOT IN ('w','$')
LEFT JOIN
...
ON
ol.order_record_id = o.id AND o.accounting_unit_code_num = '12'
LEFT JOIN
