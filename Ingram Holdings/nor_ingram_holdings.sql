...
DROP TABLE IF EXISTS nor_bibs;

CREATE TEMP TABLE nor_bibs AS
...
ON
l.item_record_id = i.id  AND i.location_code ~ '^no' --AND i.item_status_code NOT IN ('w','$')
LEFT JOIN
...
ON
ol.order_record_id = o.id AND o.accounting_unit_code_num = '29'
LEFT JOIN
