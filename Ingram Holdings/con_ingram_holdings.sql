...
DROP TABLE IF EXISTS con_bibs;

CREATE TEMP TABLE con_bibs AS
...
ON
l.item_record_id = i.id  AND i.location_code ~ '^co' --AND i.item_status_code NOT IN ('w','$')
LEFT JOIN
...
ON
ol.order_record_id = o.id AND o.accounting_unit_code_num = '8'
LEFT JOIN
