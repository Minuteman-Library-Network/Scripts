...
def main():
    query = """
      --Find patrons in the fourth quarter of MLN libraries whose cards will expire in 30 days
      SELECT
        MIN(n.first_name),
        MIN(n.last_name),
      ...
      AND p.ptype_code IN('35', '36', '137', '37', '38', '39', '40', '41', '42', '43', '200', '201', '202', '203', '335', '336', '337', '338', '339', '340', '341', '342') 
      GROUP BY 5, 4
      """
...
if __name__ == "__main__":
    try:
        ...
        email_subject = "expiring patrons 4 script error"
        email_message = (
