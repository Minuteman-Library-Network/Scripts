...
def main():
    query = """
      --Find patrons in the second quarter of MLN libraries who got a library card yesterday
      SELECT
        MIN(n.first_name),
        MIN(n.last_name),
      ...
      WHERE m.creation_date_gmt::date = (CURRENT_DATE - interval '1 day')
        ...
        AND p.ptype_code IN('14', '15', '17', '18', '115', '117', '20', '21', '22', '23', '24', '120')  
...
if __name__ == "__main__":
    try:
        ...
        email_subject = "welcome e-mail 2 script error"
        email_message = (
