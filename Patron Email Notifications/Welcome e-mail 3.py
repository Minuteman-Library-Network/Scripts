...
def main():
    query = """
      --Find patrons in the third quarter of MLN libraries who got a library card yesterday
      SELECT
        MIN(n.first_name),
        MIN(n.last_name),
      ...
      WHERE m.creation_date_gmt::date = (CURRENT_DATE - interval '1 day')
        ...
        AND p.ptype_code IN('26', '27', '30', '121', '122', '130', '42', '46', '31', '32', '133', '33', '34')  
...
if __name__ == "__main__":
    try:
        ...
        email_subject = "welcome e-mail 3 script error"
        email_message = (
