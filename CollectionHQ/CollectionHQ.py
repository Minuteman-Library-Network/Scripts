...
Gather monthly collection data for CollectionIQ and FTP results as csv files
...
def ftp_file(file):
    ...
    fp.close()
    ftp.quit()
    #delete local copy of file once sent
    os.remove(file)
...
if __name__ == "__main__":
    try:
        ...
        email_subject = "CollectionHQ script error"
        email_message = (
