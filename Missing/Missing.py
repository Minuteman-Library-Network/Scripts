...
def sftp_file(local_file, file_name, library):
    ...
    remote_path = "/reports/Library-Specific Reports/{}/Missing Items".format(library)
...
def main(library,libcode):
    ...
    try:
      ...
      # Name of Excel File
      file_name = "{}MissingItems{}.xlsx".format(libcode,date.today().replace(day=1).strftime("%b%Y"))
      excel_file =  "/Scripts/Missing/Temp Files/{}".format(file_name)
