...
Creates weekly purchase alert excel files for each library
files are uploaded to internal staff site for distribution
"""
...
def main(library,library_code,acq_unit):
    try:
        ...
        email_subject = "new purchase alert: " + library + " script error"
        email_message = (
