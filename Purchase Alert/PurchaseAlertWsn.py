...
"""
Create weekly purchase alert customized to Weston's parameters
Addition of earliest/latest locally placed hold dates
...
def excel_writer(query_results,excel_file):
    ...
    worksheet_all.set_landscape()
    worksheet_all.hide_gridlines(0)
    ...
    worksheet_all.set_column(0,0,14.14)
    worksheet_all.set_column(1,1,42.43)
    worksheet_all.set_column(2,2,26.57)
    worksheet_all.set_column(3,3,10.14)
    worksheet_all.set_column(4,4,13)
    worksheet_all.set_column(5,5,9.14)
    worksheet_all.set_column(6,6,12.71)
    worksheet_all.set_column(7,7,8.71)
    worksheet_all.set_column(8,8,12.43)
    worksheet_all.set_column(9,9,12.71)
    worksheet_all.set_column(10,10,9.57)
    worksheet_all.set_column(11,11,22)
    worksheet_all.set_column(12,12,8.57)
    worksheet_all.set_column(13,13,12.43)
    worksheet_all.set_column(14,14,17.14)
    worksheet_all.set_column(15,15,13.57)
    worksheet_all.set_column(16,16,45.71)
    worksheet_all.set_column(17,17,10.11)
    worksheet_all.set_column(18,18,11)
    ...
    worksheet_adf.set_column(17,17,10.11)
    worksheet_adf.set_column(18,18,11)
    ...
    worksheet_adnf.set_column(17,17,10.11)
    worksheet_adnf.set_column(18,18,11)
    ...
    worksheet_adlp.set_column(17,17,10.11)
    worksheet_adlp.set_column(18,18,11)
    ...
    worksheet_adunknown.set_column(17,17,10.11)
    worksheet_adunknown.set_column(18,18,11)
    ...
    worksheet_adav.set_column(17,17,10.11)
    worksheet_adav.set_column(18,18,11)
    ...
    worksheet_j.set_column(17,17,10.11)
    worksheet_j.set_column(18,18,11)
    ...
    worksheet_ya.set_column(17,17,10.11)
    worksheet_ya.set_column(18,18,11)
    ...
    worksheet_other.set_column(17,17,10.11)
    worksheet_other.set_column(18,18,11)

    #Inserting a header
    worksheet_adf.set_header('Purchase Alert')

    # Adding column labels
    worksheet_all.write(0,0,'Record_number', eformatlabel)
    worksheet_all.write(0,1,'Title', eformatlabel)
    worksheet_all.write(0,2,'Author', eformatlabel)
    worksheet_all.write(0,3,'PublicationYear', eformatlabel)
    worksheet_all.write(0,4,'MatType', eformatlabel)
    worksheet_all.write(0,5,'TotalItemCount', eformatlabel)
    worksheet_all.write(0,6,'TotalAvailableItemCount', eformatlabel)
    worksheet_all.write(0,7,'TotalHoldCount', eformatlabel)
    worksheet_all.write(0,8,'TotalDemandRatio', eformatlabel)
    worksheet_all.write(0,9,'LocalAvailableItemCount', eformatlabel)
    worksheet_all.write(0,10,'LocalOrderCopies', eformatlabel)
    worksheet_all.write(0,11,'LocalCopiesInProcess', eformatlabel)
    worksheet_all.write(0,12,'LocalHoldCount', eformatlabel)
    worksheet_all.write(0,13,'LocalDemandRatio', eformatlabel)
    worksheet_all.write(0,14,'SuggestedPurchaseQty (3)', eformatlabel)
    worksheet_all.write(0,15,'OrderLocations', eformatlabel)
    worksheet_all.write(0,16,'IsbnUPC', eformatlabel)
    worksheet_all.write(0,17,'OldestLocalHold', eformatlabel)
    worksheet_all.write(0,18,'NewestLocalHold', eformatlabel)
    ...
    worksheet_adf.write(0,17,'OldestLocalHold', eformatlabel)
    worksheet_adf.write(0,18,'NewestLocalHold', eformatlabel)
    ...
    worksheet_adnf.write(0,17,'OldestLocalHold', eformatlabel)
    worksheet_adnf.write(0,18,'NewestLocalHold', eformatlabel)
    ...
    worksheet_adlp.write(0,17,'OldestLocalHold', eformatlabel)
    worksheet_adlp.write(0,18,'NewestLocalHold', eformatlabel)
    ...
    worksheet_adunknown.write(0,17,'OldestLocalHold', eformatlabel)
    worksheet_adunknown.write(0,18,'NewestLocalHold', eformatlabel)
    ...
    worksheet_adav.write(0,17,'OldestLocalHold', eformatlabel)
    worksheet_adav.write(0,18,'NewestLocalHold', eformatlabel)
    ...
    worksheet_j.write(0,17,'OldestLocalHold', eformatlabel)
    worksheet_j.write(0,18,'NewestLocalHold', eformatlabel)
    ...
    worksheet_ya.write(0,17,'OldestLocalHold', eformatlabel)
    worksheet_ya.write(0,18,'NewestLocalHold', eformatlabel)
    ...
    worksheet_other.write(0,17,'OldestLocalHold', eformatlabel)
    worksheet_other.write(0,18,'NewestLocalHold', eformatlabel)
    ...
    for rownum, row in enumerate(query_results):
        worksheet_all.write(rownum+1,0,row[0], eformat)
        worksheet_all.write_url(rownum+1,1,row[13], link_format, row[1])
        worksheet_all.write(rownum+1,2,row[2], eformat)
        worksheet_all.write(rownum+1,3,row[3], eformat)
        worksheet_all.write(rownum+1,4,row[4], eformat)
        worksheet_all.write(rownum+1,5,row[5], eformat)
        worksheet_all.write(rownum+1,6,row[6], eformat)
        worksheet_all.write(rownum+1,7,row[7], eformat)
        worksheet_all.write(rownum+1,8,row[8], eformat)
        worksheet_all.write(rownum+1,9,row[9], eformat)
        worksheet_all.write(rownum+1,10,row[10], eformat)
        worksheet_all.write(rownum+1,11,row[18], eformat)
        worksheet_all.write(rownum+1,12,row[11], eformat)
        worksheet_all.write(rownum+1,13,row[12], eformat)
        worksheet_all.write(rownum+1,14,suggested_purchase_formula.format(rownum+2,rownum+2,rownum+2,rownum+2,rownum+2,rownum+2,rownum+2,rownum+2), eformat)
        worksheet_all.write(rownum+1,15,row[14], eformat)
        worksheet_all.write(rownum+1,16,row[15], eformat)
        worksheet_all.write(rownum+1,17,row[19], dateformat)
        worksheet_all.write(rownum+1,18,row[20], dateformat)
        ...
        if row[4] == 'LARGE PRINT':
            ...
            worksheet_adlp.write(row_adlp,17,row[19], dateformat)
            worksheet_adlp.write(row_adlp,18,row[20], dateformat)
            row_adlp += 1
            ...
            worksheet_adf.write(row_adf,17,row[19], dateformat)
            worksheet_adf.write(row_adf,18,row[20], dateformat)
            row_adf += 1
            ...
            worksheet_adnf.write(row_adnf,17,row[19], dateformat)
            worksheet_adnf.write(row_adnf,18,row[20], dateformat)
            row_adnf += 1
            ...
            worksheet_adunknown.write(row_adunknown,17,row[19], dateformat)
            worksheet_adunknown.write(row_adunknown,18,row[20], dateformat)
            row_adunknown += 1
        elif row[16] == 'JUV':
            ...
            worksheet_j.write(row_j,17,row[19], dateformat)
            worksheet_j.write(row_j,18,row[20], dateformat)
            row_j += 1
        elif row[16] == 'YA':
            ...
            worksheet_ya.write(row_ya,17,row[19], dateformat)
            worksheet_ya.write(row_ya,18,row[20], dateformat)
            row_ya += 1
            ...
            worksheet_adav.write(row_adav,17,row[19], dateformat)
            worksheet_adav.write(row_adav,18,row[20], dateformat)
            row_adav += 1
        else:
            ...
            worksheet_other.write(row_other,17,row[19], dateformat)
            worksheet_other.write(row_other,18,row[20], dateformat)
            row_other += 1
...
def main():
    ...
    query = r"""
        ...
        hold_data AS(
          SELECT 
    	    ...
    	    COUNT(DISTINCT h.id) FILTER(WHERE h.pickup_location_code ~ '^ws') AS local_holds,
    	    COUNT(DISTINCT i.id) AS item_count,
    	    COUNT(DISTINCT ia.id) AS avail_item_count, 
    	    COUNT(DISTINCT ia.id) FILTER(WHERE ia.location_code ~ '^ws' AND rmia.creation_date_gmt::DATE >= CURRENT_DATE - INTERVAL '14 days') AS in_process_item_count,
    	    COUNT(DISTINCT ia.id) FILTER(WHERE ia.location_code ~ '^ws') AS local_avail_item_count,
          ...
          LEFT JOIN sierra_view.item_record ia
    	    ...
    	    AND (
    	      (ia.location_code !~ '^ws' AND ia.itype_code_num NOT IN ('5','21','109','133','160','183','239','240','241','244','248','249'))
    	      OR ia.location_code ~ '^ws'
    	    )
        ...
        SELECT * FROM (
          ...
          LEFT JOIN sierra_view.phrase_entry d
    	    ON hd.bib_id = d.record_id AND d.index_tag = 'd'
          ...
          GROUP BY 1, 2, 3, 4, 5, 6, 8, 12, 14, 15, 16, 17, 20, 21
    ...
    #Name of Excel File
    excel_file =  "/Scripts/Purchase Alert/Temp Files/WSNPurchaseAlertCustom{}.xlsx".format(date.today())
    excel_writer(query_results,excel_file)
    sftp_file("C:\\Scripts\\Purchase Alert\\Temp Files\\WSNPurchaseAlertCustom{}.xlsx".format(date.today()), 'Weston')
...
if __name__ == "__main__":
    try:
        ...
        email_subject = "Weston Custom Purchase Alert script error"
        email_message = (
